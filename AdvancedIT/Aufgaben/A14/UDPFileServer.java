package AdvancedIT.Aufgaben.A14;
...
public class UDPFileServer {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String befehl = new String(empfangen.getData(), 0, empfangen.getLength()); // Nachricht in String umwandeln
            System.out.println("Empfangen: " + befehl);

            if (befehl.startsWith("WRITE ")) {
                String nachricht = befehl.substring(5); // "SAVE " entfernen
                String filename = nachricht.split(",")[0]; // Dateiname extrahieren
                String zeilennummer = nachricht.split(",")[1]; // Inhalt extrahieren
                String content = nachricht.split(",")[2]; // Inhalt extrahieren

                String antwort = saveMessage(filename, zeilennummer, content);

                System.out.println("Response von der speichern methode: "+antwort);
                ...
                server.send(senden);  // Antwort senden
